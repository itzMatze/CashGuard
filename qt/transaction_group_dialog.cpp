...
#include "ui_transaction_group_dialog.h"
...
TransactionGroupDialog::TransactionGroupDialog(QWidget *parent)
	: QDialog(parent)
	, ui(new Ui::TransactionGroupDialog)
	, transactionModel()
{
...
void TransactionGroupDialog::update()
{
	Amount totalAmount = getCurrentTotalAmount(transactionModel);
	ui->totalAmountLabel->setText(totalAmount.toString());
}
